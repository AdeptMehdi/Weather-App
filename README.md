...
### صفحه اصلی آفتابی
![صفحه اصلی](./screenshots/sunny-main.png)

### حالت بارانی
![حالت بارانی](./screenshots/rainy-weather.png)

### حالت برفی
![حالت برفی](./screenshots/snowy-weather.png)

### حالت شب
![حالت شب](./screenshots/night-weather.png)
